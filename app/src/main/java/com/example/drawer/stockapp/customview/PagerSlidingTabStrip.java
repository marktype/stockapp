...
//        canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, rectPaint);
        ...
        canvas.drawRect(0, height - underlineHeight, 0, height, rectPaint);
...
//        float lineLeft = currentTab.getLeft();
        ...
        canvas.drawRect(lineLeft+40, height - indicatorHeight, lineRight-40, height, rectPaint);     //+和-40为调整指示条显示长度与位置
//        canvas.drawLine(lineLeft+40,height,lineRight-40,height,rectPaint);
